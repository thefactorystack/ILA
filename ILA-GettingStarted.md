...
You have read the [ILA Overview](ILA-Overview.md). You understand the five layers and the five rules. Now you want to see what it looks like in practice — on a real machine, with real tags, real PLC code, and real network decisions.
