...
- Facilitating RFC decisions and publishing rationale
- Appointing Working Group Leads in consultation with the community
...
Core Contributor status is earned through consistent contribution over time. Any community member may be nominated by an existing Core Contributor. The Founder confirms appointments.
...
- Reporting status to the broader community on a regular cadence
- Raising RFCs when working group outputs require changes to the core specification

**Formation:**
Any community member may propose a new Working Group via the RFC process. Working Groups are formally established by the Founder upon community consensus.

---

### Community Members

All participants in ILA forums, GitHub repositories, LinkedIn discussions, and other community spaces are Community Members.

**Rights:**
- Propose changes via the RFC process
- Comment on open RFCs
- Share projects, implementations, and feedback
- Participate in community calls

There is no application process. Joining the community means agreeing to the Code of Conduct.
...
Working Groups make decisions within their defined scope autonomously. Decisions that require changes to the Core Specification must go through the RFC process.

---

## RFC Process (Request for Comments)

The RFC process ensures that significant changes are discussed openly before they are adopted.

**When is an RFC required?**
- Any change to the ILA Core Specification
...
|---|---|---|
| **Draft** | Author's discretion | RFC is authored and submitted as a pull request |
| **Open for Comment** | Minimum 14 days | Community reviews and comments via GitHub |
| **Decision** | — | Founder or Core Contributors publish a decision with rationale |
| **Accepted / Rejected / Deferred** | — | RFC is closed with documented outcome |
...
ILA is a professional community. All participants are expected to:
...
- Contributions to the Practical Layer are encouraged from all community members
- Language: English is the working language for all documentation and code comments
...
This governance document may be amended through the RFC process. Any community member may propose an amendment. Changes require Founder approval and are documented with rationale.
