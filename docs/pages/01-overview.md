...
See: [Layer 1 — Field](03-layer1-field.md) and [Layer 2 — Control](04-layer2-control.md) for naming conventions.
...
See: [Layer 3 — Supervisory](05-layer3-supervisory.md)
...
See: [Layer 5 — OT Platform](07-layer5-otplatform.md)
...
See: [Layer 4 — Data](06-layer4-data.md)
...
See: [Layer 2 — Control](04-layer2-control.md)
...
For a detailed comparison of how ILA's decisions relate to the standards, see [Standards Bridge](08-standards-bridge.md).

## How to Use This Framework

1. **New to ILA?** Start with the [Getting Started](02-getting-started.md) guide — a hands-on walkthrough applying all five layers to a single machine.
...
4. **Read the [Standards Bridge](08-standards-bridge.md)** to understand where ILA makes decisions that the standards leave open.
